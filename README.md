...
The term also might create a connection with Microservices architectures. This app does not provide a true microservice architecture, that's not its intention, but there is certainly an overlap with microservices concepts.
